...
- **[Complete Setup Guide](utils/getting_started.md)** - Step-by-step environment setup
- **[Prerequisites & Requirements](utils/getting_started.md#-prerequisites)** - What you need to know
- **[Learning Paths](utils/getting_started.md#-learning-paths)** - Choose your track
- **[Troubleshooting](utils/getting_started.md#-troubleshooting)** - Common issues and solutions
